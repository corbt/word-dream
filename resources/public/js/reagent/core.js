...
var G__5409__delegate = function (type,props,child,children){
if(!(cljs.core.map_QMARK_.call(null,props))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1780568534,null),new cljs.core.Symbol(null,"props","props",2093813254,null)))))].join('')));
}
...
var G__5409 = function (type,props,child,var_args){
var children = null;
if (arguments.length > 3) {
var G__5410__i = 0, G__5410__a = new Array(arguments.length -  3);
while (G__5410__i < G__5410__a.length) {G__5410__a[G__5410__i] = arguments[G__5410__i + 3]; ++G__5410__i;}
  children = new cljs.core.IndexedSeq(G__5410__a,0);
} 
return G__5409__delegate.call(this,type,props,child,children);};
G__5409.cljs$lang$maxFixedArity = 3;
G__5409.cljs$lang$applyTo = (function (arglist__5411){
var type = cljs.core.first(arglist__5411);
arglist__5411 = cljs.core.next(arglist__5411);
var props = cljs.core.first(arglist__5411);
arglist__5411 = cljs.core.next(arglist__5411);
var child = cljs.core.first(arglist__5411);
var children = cljs.core.rest(arglist__5411);
return G__5409__delegate(type,props,child,children);
});
...
var G__5412 = null;
if (arguments.length > 3) {
var G__5413__i = 0, G__5413__a = new Array(arguments.length -  3);
while (G__5413__i < G__5413__a.length) {G__5413__a[G__5413__i] = arguments[G__5413__i + 3]; ++G__5413__i;}
G__5412 = new cljs.core.IndexedSeq(G__5413__a,0);
}
return create_element__4.cljs$core$IFn$_invoke$arity$variadic(type,props,child, G__5412);
}
...
var _STAR_non_reactive_STAR_5415 = reagent.impl.component._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_5415;
}});
...
var _STAR_non_reactive_STAR_5417 = reagent.impl.component._STAR_non_reactive_STAR_;
try{reagent.impl.component._STAR_non_reactive_STAR_ = true;

return (React["renderToStaticMarkup"])(reagent.core.as_element.call(null,component));
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_5417;
}});
...
var G__5418__delegate = function (x,rest){
return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__5418 = function (x,var_args){
var rest = null;
if (arguments.length > 1) {
var G__5419__i = 0, G__5419__a = new Array(arguments.length -  1);
while (G__5419__i < G__5419__a.length) {G__5419__a[G__5419__i] = arguments[G__5419__i + 1]; ++G__5419__i;}
  rest = new cljs.core.IndexedSeq(G__5419__a,0);
} 
return G__5418__delegate.call(this,x,rest);};
G__5418.cljs$lang$maxFixedArity = 1;
G__5418.cljs$lang$applyTo = (function (arglist__5420){
var x = cljs.core.first(arglist__5420);
var rest = cljs.core.rest(arglist__5420);
return G__5418__delegate(x,rest);
});
...
var G__5421 = null;
if (arguments.length > 1) {
var G__5422__i = 0, G__5422__a = new Array(arguments.length -  1);
while (G__5422__i < G__5422__a.length) {G__5422__a[G__5422__i] = arguments[G__5422__i + 1]; ++G__5422__i;}
G__5421 = new cljs.core.IndexedSeq(G__5422__a,0);
}
return atom__2.cljs$core$IFn$_invoke$arity$variadic(x, G__5421);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__5423__i = 0, G__5423__a = new Array(arguments.length -  2);
while (G__5423__i < G__5423__a.length) {G__5423__a[G__5423__i] = arguments[G__5423__i + 2]; ++G__5423__i;}
  args = new cljs.core.IndexedSeq(G__5423__a,0);
} 
return wrap__delegate.call(this,value,reset_fn,args);};
wrap.cljs$lang$maxFixedArity = 2;
wrap.cljs$lang$applyTo = (function (arglist__5424){
var value = cljs.core.first(arglist__5424);
arglist__5424 = cljs.core.next(arglist__5424);
var reset_fn = cljs.core.first(arglist__5424);
...
if((function (){var G__5427 = ra;
if(G__5427){
var bit__4416__auto__ = (G__5427.cljs$lang$protocol_mask$partition0$ & (32768));
if((bit__4416__auto__) || (G__5427.cljs$core$IDeref$)){
return true;
} else {
if((!G__5427.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IDeref,G__5427);
} else {
return false;
}
}
...
var G__5429__delegate = function (path,ra,reset_fn,args){
if((function (){var G__5428 = ra;
if(G__5428){
var bit__4416__auto__ = (G__5428.cljs$lang$protocol_mask$partition0$ & (32768));
if((bit__4416__auto__) || (G__5428.cljs$core$IDeref$)){
return true;
} else {
if((!G__5428.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IDeref,G__5428);
} else {
return false;
}
}
...
var G__5429 = function (path,ra,reset_fn,var_args){
var args = null;
if (arguments.length > 3) {
var G__5430__i = 0, G__5430__a = new Array(arguments.length -  3);
while (G__5430__i < G__5430__a.length) {G__5430__a[G__5430__i] = arguments[G__5430__i + 3]; ++G__5430__i;}
  args = new cljs.core.IndexedSeq(G__5430__a,0);
} 
return G__5429__delegate.call(this,path,ra,reset_fn,args);};
G__5429.cljs$lang$maxFixedArity = 3;
G__5429.cljs$lang$applyTo = (function (arglist__5431){
var path = cljs.core.first(arglist__5431);
arglist__5431 = cljs.core.next(arglist__5431);
var ra = cljs.core.first(arglist__5431);
arglist__5431 = cljs.core.next(arglist__5431);
var reset_fn = cljs.core.first(arglist__5431);
var args = cljs.core.rest(arglist__5431);
return G__5429__delegate(path,ra,reset_fn,args);
});
...
var G__5432 = null;
if (arguments.length > 3) {
var G__5433__i = 0, G__5433__a = new Array(arguments.length -  3);
while (G__5433__i < G__5433__a.length) {G__5433__a[G__5433__i] = arguments[G__5433__i + 3]; ++G__5433__i;}
G__5432 = new cljs.core.IndexedSeq(G__5433__a,0);
}
return cursor__4.cljs$core$IFn$_invoke$arity$variadic(path,ra,reset_fn, G__5432);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var args = null;
if (arguments.length > 1) {
var G__5434__i = 0, G__5434__a = new Array(arguments.length -  1);
while (G__5434__i < G__5434__a.length) {G__5434__a[G__5434__i] = arguments[G__5434__i + 1]; ++G__5434__i;}
  args = new cljs.core.IndexedSeq(G__5434__a,0);
} 
return partial__delegate.call(this,f,args);};
partial.cljs$lang$maxFixedArity = 1;
partial.cljs$lang$applyTo = (function (arglist__5435){
